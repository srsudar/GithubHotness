...
public class RepoRecyclerViewAdapter extends RecyclerView.Adapter<RepoRecyclerViewAdapter
  ...
  static class RepoViewHolder extends RecyclerView.ViewHolder {
    ...
    RepoViewHolder(View view) {
      super(view);
      this.wholeView = view;
      this.name = (TextView) view.findViewById(com.samsudar.thehotness.R.id.repo_name);
      this.description = (TextView) view.findViewById(com.samsudar.thehotness.R.id.repo_description);
      this.stars = (TextView) view.findViewById(com.samsudar.thehotness.R.id.repo_stars);
    }
  }
  ...
  public RepoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    View repoView = inflater.inflate(com.samsudar.thehotness.R.layout.repo_view, parent, false);
