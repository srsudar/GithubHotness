package com.samsudar.githubhotness.ui.view;
...
import com.samsudar.githubhotness.persistence.PreferenceAccessor;
import com.samsudar.githubhotness.ui.view.presenter.RepoListViewPresenter;
import com.samsudar.githubhotness.ui.widget.RepoRecyclerViewAdapter;
...
public class RepoListViewTest {
  ...
  public void before() {
    ...
    LayoutInflater inflater = LayoutInflater.from(RuntimeEnvironment
        .application);
    repoListView = (RepoListView) inflater.inflate(com.samsudar.githubhotness.R.layout
